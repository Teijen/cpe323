...
hw:
			...
			push	R6
			push	R7
			mov.w	14(SP),R6				;get array length
			mov.w 	16(SP),R4				;get starting address of arr1
			mov.w	12(SP),R5 				;get starting address of arr2
			mov.w	10(SP),R7				;get base address of res1
nextnum:	mov.w	@R4+,&MPYS				;get array ind 1 into mult
			mov.w	@R5+,&OP2
			mov.w	RESLO,0(R7)
